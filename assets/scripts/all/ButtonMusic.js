cc.Class({
    ...
    start() {
        ...
        //注：获取的数据类型为字符串而非布尔型
        this.onoff = cc.sys.localStorage.getItem('buttonMusic');
        ...
        if (this.onoff == null) {
            this.onoff = true;
            cc.sys.localStorage.setItem('buttonMusic', this.onoff);
        }
        ...
        this.soundController.controllBackgroundMusic(this.onoff, this.musicType);
    },
